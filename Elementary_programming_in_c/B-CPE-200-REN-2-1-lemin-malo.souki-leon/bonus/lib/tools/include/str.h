...
//upgrade version of my_strlen
unsigned int str_len(const char *str);

//upgrade version of str_dup
char *str_dup(const char *str);

//upgrade version of str_recat
char *str_cat(char *dest, const char *src);

//print str on canal 2
void print_error(const char *str);


/**
 * @brief copy a string a returns the string
 *
 * @param src
 * @return char*
 */
...
/**
 * @brief check is a str contains a char
 *
 * @param str
 * @param to_find
 * @return true
